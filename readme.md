# Photovoltaic (Solar Panel) Defects Dataset 5100 Samples Supports Yolo Format

# Body

Photovoltaic (Solar Panel) Defects Dataset, 5100 Sheets, Supports Yolo Format， Second-hand ， No Return or Exchange
Ideal for learning, research, projects, with comprehensive data and complete labels ready to use directly.
For those in need, please purchase immediately. Details can be privately asked.

Annotations
bird_drop Bird droppings contamination
clean Surface cleanliness
cracked Cracked surface
